...
static void testGv8();
static void testGv9();
static void testGv10();
static void testGv11();
static void testGv12();
static void testGv13();
static void testGv14();
static void testGv15();
...
static void testGv9()
{
    ...
    assert(GvGetScore(gv) == GAME_START_SCORE - 4 * SCORE_LOSS_DRACULA_TURN - SCORE_LOSS_HUNTER_HOSPITAL);
...
static void testGv13()
{
    ...
    assert(GvGetScore(gv) == GAME_START_SCORE - 7 * SCORE_LOSS_DRACULA_TURN - SCORE_LOSS_VAMPIRE_MATURES);
    assert(GvGetPlayerLocation(gv, PLAYER_DRACULA) == CITY_UNKNOWN);
    assert(GvGetVampireLocation(gv) == NOWHERE);
